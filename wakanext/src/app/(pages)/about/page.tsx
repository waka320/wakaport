    ...
    return (
        <div className={`relative crt-overlay min-h-screen py-4 md:py-6 transition-opacity duration-500 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
            <div className="container px-1 md:px-4">
                <h1 className="text-center text-3xl font-bold mb-4 md:mb-6 text-[var(--primary)]">
                    WakamatsuYukiについて
                </h1>
                <div className="space-y-3">
                    ...
                    <section className="content-background pixel-panel mb-3 p-3 md:p-4 rounded-lg">
                        <h2 className="text-xl md:text-2xl font-semibold mb-2">経歴</h2>
