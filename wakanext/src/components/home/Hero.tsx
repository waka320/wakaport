        ...
        <div className="flex container min-h-[100svh] items-start relative">
            ...
            <div className="absolute bottom-24 right-24 flex flex-col items-end">
                ...
                >
                    ...
                    {/* ラベル部分 */}
                    <div className="absolute bottom-[-10px] right-[-10px] px-2 py-1 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-300 rounded-full text-xs rotate-12 transition-all duration-300 group-hover:bottom-[-5px] group-hover:right-[-5px]">
                        #GitHub
                    </div>

                    {/* ホバー時のヒント - 初期状態では非表示 */}
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-indigo-600/80 dark:bg-indigo-500/80 text-white px-4 py-2 rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100 whitespace-nowrap z-20">
                        GitHub
                    </div>
                </a>
            </div>
