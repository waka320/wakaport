        ...
        <div className="flex flex-col lg:flex-row container min-h-screen lg:min-h-[100svh] items-center justify-between lg:items-start relative px-4 py-8 lg:py-0">
            <div className="w-full lg:flex-[3] flex justify-center lg:justify-start">
                <div className="mt-8 lg:mt-32 mx-auto lg:mx-3 p-4 lg:p-6 border-4 border-gray-800 dark:border-gray-200 hero shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-sm">
                    <h1 className="text-3xl lg:text-5xl font-bold border-none text-center lg:text-left">welcome to <br />
                        <span className="text-5xl lg:text-9xl relative">
                    ...
                    <p className="mt-4 text-gray-600 dark:text-gray-300 font-light text-center lg:text-left">my Portal and Portfolio.</p>
                </div>
            </div>
